...
Thank you for your interest in raising an issue with Medusa Connector. An issue can be either a bug report or a feature request.

By reporting bugs, you contribute directly to improving Medusa Connector. Bug reports help developers identify and fix issues quickly before they affect more users.
...
2. **Version number:**  
   Include the Medusa Connector version, along with your Frappe, ERPNext and Ecommerce Core versions. The issue may already be fixed in a newer release.

3. **Clear title:**  
   Use a descriptive title (e.g., "Unable to import products from Medusa" instead of "Sync not working").
